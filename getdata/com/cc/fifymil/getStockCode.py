...
#保存股票代码到文件中#
with open('AllSzAStock.json',mode='w') as f:
    json.dump(AllSzAStock.Data[0],f);
with open('AllShAStock.json',mode='w') as f1:
    json.dump(AllShAStock.Data[0],f1);
with open('AllAStock.json',mode='w') as f2:
    json.dump(AllAStock.Data[0],f2);
